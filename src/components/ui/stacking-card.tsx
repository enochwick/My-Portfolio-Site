...
export function Card({
  ...
  // image parallax as the card enters, and the card shrinks as later cards stack on top
...
/**
 * Sticky stacking cards. Each card pins to the top and shrinks as the next
 * one stacks over it, driven by scroll progress across the whole list.
 *
 * Note: relies on the app-level Lenis instance (SmoothScroll) — it does not
 * mount its own, which would conflict.
 */
