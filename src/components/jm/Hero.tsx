        ...
        <div className="sticky top-0 h-[100svh] overflow-hidden">
          ...
          <div className="relative z-10 mx-auto flex h-[100svh] max-w-[1500px] flex-col px-5 md:px-10">
            ...
            <div className="relative flex flex-1 items-center justify-center py-6">
              <div className="relative mx-auto w-full max-w-[1200px] -translate-y-6 md:-translate-y-8">
                {/* HENOK — behind the photo, slides right + fades */}
                <motion.h1
                  style={{ x: henokX, opacity: henokO }}
                  className="jm-display relative z-10 text-center text-[24vw] uppercase leading-[0.82] text-paper md:text-[13vw]"
                >
                ...
                <motion.h1
                  ...
                  className="jm-display relative z-30 text-center text-[24vw] uppercase leading-[0.82] text-paper md:text-[13vw]"
                >
